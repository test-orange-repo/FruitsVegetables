...
<body>
    ...
    <div class="body-wrap overflow-hidden">
        ...
        <main>
                        ...
                        <div class="row">
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                                ...
                                <div class="offcanvas-body">
                                    <div class="prdc_ctg_product_content one d-flex align-items-center">
                                        <div
                                    ...
                                    <div class="prdc_ctg_product_content two d-flex align-items-center">
                                        <div
                                            class="prdc_ctg_product_img d-flex justify-content-center align-items-center me-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="product_gallery">
                                    <img src="assets/images/sales/sale8.png" alt="image_not_found">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="product_section_content about_section_content">
                                    ...
                                    <div class="product_section_title text-effect py-2">
                                        <h2>About our <font>
                                                <span>S</span><span>t</span>o<span>r</span>y<span></span><span></span>
                                            </font>
                                        </h2>
                                    </div>
                                    <div class="product_section_subtitle position-relative">
                                        <p class="pb-0">
                                            At FruitsVegetables, we take immense pride in providing you with the
                                            freshest and most flavorful assortment of vegetables and fruits. Our
                                            commitment to quality drives us to source produce from local farmers and
                                            trusted suppliers, ensuring that each item on your plate is bursting with
                                            natural goodness. From the vibrant colors to the exquisite tastes, our
                                            carefully curated selection reflects our passion for healthy living and
                                            sustainable practices. Join us in savoring the bounty of nature, as we bring
                                            you a diverse array of wholesome vegetables and fruits that inspire
                                            nourishment and well-being in every bite,where we bring nature's finest
                                            harvest right to your table. Our journey is rooted in a love for farm-fresh
                                            vegetables and fruits that delight the senses and nurture the body. With a
                                            firm commitment to excellence, we meticulously select each piece of produce
                                            to ensure it meets our rigorous standards of quality and taste</p>
                                    </div>
            ...
            <img class="category_left_thumb position-absolute" src="assets/images/shapes/shape3.png"
                alt="image_not_found">
            ...
            <section class="product_video_sec">
                <div class="product_video_wrap overflow-hidden sec_space_xxlarge"
                    style="background-image: url(assets/images/backgrounds/bg12.png);">
                    <div class="product_video_player slideshow5_slider" data-slick='{"dots": false}'>
                        <div class="product_video_slide_item d-flex justify-content-center align-items-center mx-5">
                            <a class="product_media_icon d-flex justify-content-center align-items-center" href="#!"
                                data-bs-toggle="modal" data-bs-target="#exampleModal2"><i
                                    class="fas fa-play text-white d-flex justify-content-center align-items-center"></i></a>
                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <iframe width="450" height="300" src="https://www.youtube.com/embed/UqyD2PgOw9Q"
            ...
            <!-- team section start -->
            <section class="team_section sec_space_xxs_50 position-relative" data-aos="fade-up"
                ...
                <div class="team_section_content">
                    <div class="team_top_content">
                        ...
                        <div class="team_top_title text-center py-4">
                            <h2>Our <span style="color: #81c408;">Team</span></h2>
                        </div>
                    </div>
                    <div class="team_inner_content">
                        <div class="container">
                            <div class="card-group justify-content-center align-items-center">
                                <div class="team_content_wrap position-relative">
                                    <div class="row g-4">
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-right"
                                                ...
                                                <div class="card-body team_author_content">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                                                            <i class="fab fa-twitter"></i>
                                                        </a>
                                                        <a class="social_face" href="https://www.facebook.com/">
                                                            <i class="fab fa-facebook-square"></i>
                                                        </a>
                                                        <a class="social_linked" href="https://www.linkedin.com/?original_referer=">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-right"
                                                data-aos-duration="2000">
                                                <img class="rounded-pill" src="assets/images/team/mohammad_2.png"
                                                    class="card-img-top" alt="team2">
                                                <div class="card-body team_author_content">
                                                    <h5 class="card-title team_author_title">Mohammad alghzawi</h5>
                                                    <div class="card-text team_author_post py-2"></div>
                                                    <div
                                                        class="team_author_social_link d-flex justify-content-center justify-content-around align-items-center">
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-left"
                                                data-aos-duration="2000">
                                                <img class="rounded-pill" src="assets/images/team/me.png"
                                                    class="card-img-top" alt="team2">
                                                <div class="card-body team_author_content">
                                                    <h5 class="card-title team_author_title">Lena alrababa</h5>
                                                    <div class="card-text team_author_post py-2"></div>
                                                    <div
                                                        class="team_author_social_link d-flex justify-content-center justify-content-around align-items-center">
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-left"
                                                data-aos-duration="2000">
                                                <img class="rounded-pill" src="assets/images/team/MyProfailPicture.png"
                                                    class="card-img-top" alt="team2">
                                                <div class="card-body team_author_content">
                                                    <h5 class="card-title team_author_title">Marah Abusaleh</h5>
                                                    <div class="card-text team_author_post py-2"></div>
                                                    <div
                                                        class="team_author_social_link d-flex justify-content-center justify-content-around align-items-center">
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-left"
                                                data-aos-duration="2000">
                                                <img class="rounded-pill" src="assets/images/team/1682276734770.png"
                                                    class="card-img-top" alt="team2">
                                                <div class="card-body team_author_content">
                                                    <h5 class="card-title team_author_title">Sereen Qamhieh</h5>
                                                    <div class="card-text team_author_post py-2"></div>
                                                    <div
                                                        class="team_author_social_link d-flex justify-content-center justify-content-around align-items-center">
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3">
                                            <div class="card team_content text-center" data-aos="fade-left"
                                                data-aos-duration="2000">
                                                <img class="rounded-pill" src="assets/images/team/shatha.png"
                                                    class="card-img-top" alt="team2">
                                                <div class="card-body team_author_content">
                                                    <h5 class="card-title team_author_title">shatha rababa</h5>
                                                    <div class="card-text team_author_post py-2"></div>
                                                    <div
                                                        class="team_author_social_link d-flex justify-content-center justify-content-around align-items-center">
                                                        <a class="social_twitt" href="https://twitter.com/i/flow/login">
                ...
                <img class="team_left_thumb position-absolute" src="assets/images/shapes/shape11.png"
                    alt="image_not_found">
                <img class="team_right_thumb position-absolute" src="assets/images/shapes/shape12.png"
                    alt="image_not_found">
            </section>
            <!-- team section start -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-6 col-md-3">
                                <div class="service_inner_content d-flex justify-content-center align-items-center"
