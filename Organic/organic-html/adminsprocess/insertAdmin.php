...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO admins (admin_firstname, admin_lastname, admin_username, admin_email, admin_img, admin_password) 
    VALUES ('$fName', '$lName', '$uName', '$adminEmail', '$imageData' ,'$adminPass')";
...
<div class="form-container">
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-input">
            ...
            <input type="file" id="adminImage" name="adminImage" accept="image/*" required>
        </div>
