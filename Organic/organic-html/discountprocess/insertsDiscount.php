...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO discount (discount_text, discount_percentage) VALUES ('$discountCoupon', '$discountPerc')";
...
<div class="form-container">
    <form method="post" action="" enctype="multipart/form-data">
        <div class="form-input">
            ...
            <input type="text" id="discountCoupon" name="discountCoupon" required>
        </div>
        <div class="form-input">
            <label for="discountPerc" class="form-label">Discount Percentage</label>
            <input type="text" id="discountPerc" name="discountPerc" required>
        </div>
