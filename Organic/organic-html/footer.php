                ...
                <div class="container">
                    <div class="footer_top_content d-flex flex-column flex-lg-row justify-content-between align-items-center">
                        <div class="footer_top_logo">
                            <a href="index-3.html"><img src="assets/images/logo/logo2.png" alt="image_not_found"></a>
                        </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="footer_inner_choose_content">
                                        ...
                                        <div class="footer_inner_choose_desc pt-2">
                                            <p>Tailored to Your Needs: From fresh produce to pantry staples, we offer a diverse range of products that cater to your dietary preferences and lifestyle. Your satisfaction is at the heart of everything we do. </p>
                                        </div>
                                        <div class="footer_inner_choose">
                                            <a href="./about-us.php"><button type="button" class="btn custom_btn rounded-pill px-4 text-white">View More <i class="fas fa-long-arrow-alt-right"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="footer_inner_cotc_content">
                                        ...
                                        <div class="footer_inner_ctc_info pt-2 text-white">
                                            <p>Address: <font>Jordan - Irbid City</font>
                                            </p>
                                            <p>Email: <font>Organi@gmail.com</font>
                                            </p>
                                            <p>Phone: <font>0791579601</font>
                                            </p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="footer_bootom_privicy_cont d-flex justify-content-center align-items-center">
                                            <div class="footer_bootom_privicy pe-5">
                                                <a href="#!">
                                                    <p class=" position-relative">Privacy Policy</p>
                                                </a>
                                            </div>
